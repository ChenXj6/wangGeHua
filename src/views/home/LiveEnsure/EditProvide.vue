<template>
  <div class="edit-content">
    ...
    <VForm :key="timer" :isDisabled="route.query.operation == 1" :form-data="ProvideFormConfig" :form-model="dataForm" :form-handle="route.query.operation != 1 ? formHandle : {}">
...
export default {
  ...
  setup() {
    ...
    const getLatAndLng = ({lat,lng}) => {
      ...
      dataForm.value.lon = lng.toFixed(6)
      dataForm.value.lat = lat.toFixed(6)
