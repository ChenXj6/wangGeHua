...
export default {
  ...
  setup() {
    ...
    const handleOperation = (type, rowData) => {
      ...
      router.push({
        name: 'editEconomics',
        params: { data : encodeURIComponent(data), operation: type, type:'building' },
      })
    }
    //
    const cbTypeOptions = ref([])
    ...
    getOptionsByCode(1055,cbTypeOptions)
    onMounted(()=>{
      handleQuery()
    })
    return{
