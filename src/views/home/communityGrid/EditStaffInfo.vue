<template>
  <div class="edit-content">
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form
              ...
              label-width="0"
            >
              <el-table :data="dataForm.info" size="small" style="width: 100%">
                <el-table-column prop="prop" label="网格力量类型">
                  <template #default="scope">
                   <!-- <el-form-item :prop="'dataForm.info' + scope.$index + '.type'" :rules="rules.type"> -->
                      <el-select
                ...
                <el-table-column prop="prop" label="性别">
                  <template #default="scope">
                    <el-select
                ...
                <el-table-column prop="prop" label="种类">
                  <template #default="scope">
                    <el-select
    ...
    <el-row v-if="route.query.operation == 1">
      <div class="btn-box">
        <el-button type="primary" @click="handleBack" size="small" icon="back"
          >返回</el-button
        >
      </div>
    </el-row>
  ...
  setup() {
    ...
    const getSOList = (officeCode) => {
      getSmallOrganList({ officeCode }).then((res) => {
        if (
          !dataForm.officeName &&
          dataForm.officeCode == res.data[0].officeCode
        ) {
    ...
    route.query.operation != 3 &&
      (formatReset(JSON.parse(decodeURIComponent(route.query.data)), dataForm),
      getSOList(dataForm?.officeCode))
    onMounted(() => {
