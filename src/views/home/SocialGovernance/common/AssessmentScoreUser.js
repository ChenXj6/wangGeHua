...
export function renderTable() {
    ...
    columns: [
        { prop: 'startTime', label: '开始时间',formatter: 'YYYY-MM-DD HH:mm:ss',toolTip:true, minWidth: '140' },
        { prop: 'endTime', label: '结束时间',formatter: 'YYYY-MM-DD HH:mm:ss',toolTip:true, minWidth: '140' },
