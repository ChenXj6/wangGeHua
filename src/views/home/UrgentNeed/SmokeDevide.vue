<template>
  <div>
    ...
    <template v-slot:deviceName="{data}">
      <el-link type="success" @click.prevent="handleOperation(2, data)">{{ data.deviceName }}</el-link>
    </template>
