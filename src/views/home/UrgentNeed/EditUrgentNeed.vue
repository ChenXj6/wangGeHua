<template>
  <div class="edit-content">
    ...
    <VForm v-if="route.query.type === 'team'" :key="timer" :isDisabled="route.query.operation == 1" :form-data="teamsFormConfig" :form-model="dataForm" :form-handle="route.query.operation != 1 ? formHandle : {}">
    ...
    <VForm v-else :key="timer" :isDisabled="route.query.operation == 1" :form-data="suppliesPeopleFormConfig" :form-model="dataForm" :form-handle="route.query.operation != 1 ? formHandle : {}">
      <template v-slot:gridCode="">
        <popup-tree-input
          :data="popupTreeData" :propa="popupTreeProps"
          :nodeKey="''+dataForm.officeCode" @update:dataForm="handleTreeSelectChange">
