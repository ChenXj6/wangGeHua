...
export function renderTable() {
  const tableConfig = {
    ...
    columns: [
      { prop: 'treeNames', label: '归属网格', minWidth: '150',toolTip:true },
      { type:'code',code:'1061',prop: 'dangerstatus', label: '状态', minWidth: '120'},
      { type:'code',code:'1059',prop: 'configType', label: '任务周期', minWidth: '120'},
      ...
      { prop: 'dangerinfoName', label: '隐患内容', minWidth: '120',toolTip:true },
      ...
      { type:'code',code:'1006',prop: 'isDanger', label: '是否存在隐患', minWidth: '120'},
